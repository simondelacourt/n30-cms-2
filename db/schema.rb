...
ActiveRecord::Schema.define(version: 20131007151009) do
  ...
  add_index "javascripts", ["slug"], name: "index_javascripts_on_slug", unique: true, using: :btree
  ...
  add_index "stylesheets", ["slug"], name: "index_stylesheets_on_slug", unique: true, using: :btree
